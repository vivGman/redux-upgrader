...
var apiReducer = exports.apiReducer = function apiReducer(types, Constructor, prepare, state, action) {
    switch (action.type) {
        case types.REQUEST:
...
var multiApiReducer = exports.multiApiReducer = function multiApiReducer(types, Constructor, extendKey, prepare, state, action) {
    try {
...
// export function objectReducer(setTypes, KEY, Constructor) {
